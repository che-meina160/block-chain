...
function ln_line() {
  var e_nav_on = $('.game_filter > li.on');
  var e_nav = $('.game_filter > li');
...
function ln_nav() {
  var elm_nav = $('.game_filter > li');
  var elm_on = $('.game_filter > li.on');
  var prm_idx = -1;
...
function fn_adpt() {
  var e_nav = $('.game_filter > li');
  var e_on = $('.game_filter > li.on');
  var e_bar = $('.game_filter_line');
  var tmp = g_widths[0];
